...
* In your android studio go to File -> Open Project. A window will show up. In this window navigate to Pop-Movies project's root folder (i.e. the `......../Pop-Movies-Android-App` folder) and open.
